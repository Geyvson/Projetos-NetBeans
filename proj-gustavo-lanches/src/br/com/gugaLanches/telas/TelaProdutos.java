...
public class TelaProdutos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnProdAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gugaLanches/icones/create.png"))); // NOI18N
        ...
        btnProdLimpar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gugaLanches/icones/Vassoura.png"))); // NOI18N
        ...
        btnProdEditar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gugaLanches/icones/update.png"))); // NOI18N
        ...
        btnProdExcluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gugaLanches/icones/delete.png"))); // NOI18N
        ...
        txtPreço.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
    ...
    private void pesquisarTabelaProd() {
        String sql = "select cod_prod, produto, preco_prod, qtd_prod from tb_produtos where produto like ?";
    ...
    private void pesquisarTabelaProdCod() {
        String sql = "select cod_prod, produto, preco_prod, qtd_prod from tb_produtos where cod_prod like ?";
    ...
    private void setarCampos() {
        ...
        txtPreço.setText(tblTabelaPesquisaProd.getModel().getValueAt(setar, 2).toString());
        txtQtdAtual.setText(tblTabelaPesquisaProd.getModel().getValueAt(setar, 3).toString());
    ...
    private void adicionar() {
        String sql = "insert into tb_produtos(cod_prod, produto, preco_prod, qtd_prod) values(?, ?, ?, ?)";
        ...
        try {
            ...
            pst.setString(4, txtQtdAdicionar.getText());

            if (txtCod.getText().isEmpty() || txtDesc.getText().isEmpty() || txtPreço.getText().isEmpty() || txtQtdAdicionar.getText().isEmpty()) {
    ...
    private void excluirProd() {
        ...
        if (confirma == JOptionPane.YES_OPTION) {
            String sql = "delete from tb_rodutos where cod_prod=?";
    ...
    private void editarProd() {
        ...
        String sql = "update tb_produtos set produto=?, preco_prod=?, qtd_prod=? where cod_prod=?";

        try {

            pst = conn.prepareStatement(sql);
            pst.setString(1, txtDesc.getText());
            pst.setString(2, txtPreço.getText());
            pst.setString(3, String.valueOf(soma));
            pst.setString(4, txtCod.getText());

            if (txtCod.getText().isEmpty() || txtDesc.getText().isEmpty() || txtPreço.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Preencha todos os campos obrigatorios!!!");
