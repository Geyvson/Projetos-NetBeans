...
public class TelaUsuario extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(65, 65, 65)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(cboPerfil, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGap(10, 10, 10)
        ...
        btnUsuAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/wj/icones/create.png"))); // NOI18N
        ...
        btnUsuLimpar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/wj/icones/Vassoura.png"))); // NOI18N
        ...
        btnUsuEditar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/wj/icones/update.png"))); // NOI18N
        ...
        btnUsuExcluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/wj/icones/delete.png"))); // NOI18N
        ...
        btnUsuPesquisar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/wj/icones/read.png"))); // NOI18N
    ...
    private void adicionar() {
        ...
        String sql = "insert into tb_usuarios(usuario, fone, login, senha, perfil, comissao)"
                + "values(?,?,?,?,?,? )";
        ...
        try {
            ...
            pst.setString(5,String.valueOf( cboPerfil.getSelectedItem()));
            pst.setString(6, txtComissao.getText());

            if (txtNome.getText().isEmpty() || txtLogin.getText().isEmpty() || cboPerfil.getSelectedItem().equals(" ") || txtSenha.getText().isEmpty() || txtComissao.getText().isEmpty()) {
    ...
    private void editar() {
        String sql = "update tb_usuarios set usuario=?, fone=?, login=?, senha=?, perfil=?, comissao=? where id_user=?";
    ...
    private void excluir() {
        ...
        int confirma = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja EXCLUIR esté usuário?", "Atenção !!!", JOptionPane.YES_NO_OPTION);
    ...
    private void pesquisarTabela() {
        String sql = "select id_user, usuario, fone from tb_usuarios where usuario like ?";
    ...
    private void setarCampos() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                txtComissao.setText(rs.getString(7));
